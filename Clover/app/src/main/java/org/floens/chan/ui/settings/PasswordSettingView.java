...
public class PasswordSettingView extends SettingView implements View.OnClickListener {
    private final Setting<String> setting;
    private final String dialogTitle;

    public PasswordSettingView(SettingsController settingsController, Setting<String> setting, int name, int dialogTitle) {
        this(settingsController, setting, getString(name), getString(dialogTitle));
    }

    public PasswordSettingView(SettingsController settingsController, Setting<String> setting, String name, String dialogTitle) {
    ...
    public String getBottomDescription() {
        return setting.get().length() > 0 ? "********" : null;
    }
        ...
        AlertDialog dialog = new AlertDialog.Builder(v.getContext())
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface d, int which) {
                        ...
                        settingsController.onPreferenceChange(PasswordSettingView.this);
                    }
                })
